...
module.exports = {
  ...
  onStart: async function ({ message, args }) {
    try {
      ...
      await bot.sendMessage(chatId, "⏳ Generating anime image...");

      const apiUrl = `https://dev.oculux.xyz/bot/supanime?prompt=${encodeURIComponent(prompt)}`;
      ...
      return bot.sendMessage(chatId, "❌ Failed to generate anime image.");
    }
  }
};
