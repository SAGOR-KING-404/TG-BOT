...
module.exports = {
  ...
  onStart: async function({ bot, event, threadsData, usersData }) {

    const { threadID, messageID, senderID } = event;
    const { participantIDs } = await bot.getThreadInfo(threadID);
    ...
    return bot.sendMessage(msg, chatId, msg.message_id);
  }
};