 ...
 * Và kiến thức về bot không chính thức của facebook như bot.sendMessage, bot.changeNickname,... bạn có thể tìm hiểu thêm tại đây: https://github.com/ntkhang03/fb-chat-bot/blob/master/DOCS.md
 ...
 * And knowledge of unofficial facebook bot such as bot.sendMessage, bot.changeNickname,... you can learn more at here: https://github.com/ntkhang03/fb-chat-bot/blob/master/DOCS.md
...
module.exports = {
	...
	onStart: async function ({ bot, args, message, event, threadsData, usersData, dashBoardData, globalData, threadModel, userModel, dashBoardModel, globalModel, role, commandName, getLang }) {
