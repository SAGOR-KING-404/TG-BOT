module.exports = {
	...
	onStart: async function ({ args, message, event, threadsData, getLang }) {
		...
		await threadsData.set(chatId, isSetNoti ? !value : value, keySetData);

		if (isSetNoti)
			return bot.sendMessage(chatId, value ? getLang("turnedOnNoti") : getLang("turnedOffNoti"));
		else
			return bot.sendMessage(chatId, value ? getLang("turnedOn") : getLang("turnedOff"));
	}
};