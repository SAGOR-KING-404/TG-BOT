...
const API_BASE = 'https://dev.oculux.xyz/bot/nanobanana';
...
module.exports = {
  ...
  async onStart({ message, args, event, bot, commandName }) {
    try {
      ...
      if (!prompt) return bot.sendMessage(chatId, '⚠️ Please provide a prompt.');

      bot.sendMessage(chatId, '⏳ Generating image... 🌱');
